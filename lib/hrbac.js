 ...
 * @returns {HRBAC} current HRBAC instance.
 */
  addRole(role, parents = null, userObj = null) {
    ...
    this.funcs.set(role, { func: func, userObj: userObj});
 ...
 * @returns {HRBAC} current HRBAC instance.
 */
  addBoolFunc(label, func, userObj = null) {
    ...
    this.funcs.set(label, { func: func, userObj: userObj });
 ...
 */
  or(func1, func2) {
    ...
    let funcObj1 = this._getFunc(func1);

    func1        = funcObj1.func;
    let userObj1 = funcObj1.userObj;

    let funcObj2 = this._getFunc(func2);

    func2        = funcObj2.func;
    let userObj2 = funcObj2.userObj;
 ...
 */
  not(func) {
    ...
    let funcObj = this._getFunc(func);

    func        = funcObj.func;
    let userObj = funcObj.userObj;
 ...
 */
  middleware(func, userObj = null) {

    let funcObj = this._getFunc(func);

    func            = funcObj.func;
    let userObjFunc = funcObj.userObj;
